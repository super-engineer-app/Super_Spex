...
- Token server generates valid tokens (`https://agora-token.spex-remote.workers.dev/`)
- Web viewer deployed (`https://spex-viewer.spex-remote.workers.dev/view/{channelId}`)
