...
The app includes ‘modes’ built around workflows designed specifically for use by field technicians - enabling them to do handsfree work using AI Glasses powered by the Android XR toolset + AI.
