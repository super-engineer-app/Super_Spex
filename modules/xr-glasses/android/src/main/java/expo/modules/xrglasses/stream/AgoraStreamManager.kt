...
class AgoraStreamManager(
    ...
    companion object {
        ...
        private const val VIEWER_URL_BASE = "https://spex-viewer.spex-remote.workers.dev/view/"
        private const val TOKEN_SERVER_URL = "https://agora-token.spex-remote.workers.dev/"
    }
