...
**URL:** `https://REDACTED_TOKEN_SERVER/`
...
**URL:** `https://REDACTED_VIEWER_URL/view/{channelId}`
...
**Project:** spex-remote
**App ID:** `REDACTED_AGORA_APP_ID`
**App Certificate:** `REDACTED_AGORA_CERTIFICATE`
...
**Test token server:**
```bash
curl "https://REDACTED_TOKEN_SERVER/?channel=test&role=publisher"
curl "https://REDACTED_TOKEN_SERVER/?channel=test&role=subscriber"
```

**Test web viewer:**
```bash
# Open in browser:
https://REDACTED_VIEWER_URL/view/test-channel-id
```
