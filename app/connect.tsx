      ...
      <View style={styles.content}>
            ...
            {connected ? (
              <>
                <View style={styles.connectedCard}>
                  ...
                  <Text style={styles.connectedSubtitle}>
                    {emulationMode ? 'Emulated Connection' : 'XR Glasses Connected'}
                  </Text>
                </View>
              ...
              <>
                ...
                <View style={styles.instructionsCard}>
                  <Text style={styles.instructionsTitle}>Connect to Glasses</Text>
        ...
        <View style={styles.emulationSection}>
          <View style={styles.emulationHeader}>
            ...
            <View style={[styles.emulationBadge, emulationMode && styles.emulationBadgeActive]}>
              <Text style={[styles.emulationBadgeText, emulationMode && styles.emulationBadgeTextActive]}>
          ...
          <Pressable
            style={[styles.emulationButton, emulationMode && styles.emulationButtonActive]}
