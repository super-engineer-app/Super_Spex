      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.statusItem}>
            ...
            <View style={[styles.statusBadge, engagementMode.visualsOn && styles.statusBadgeActive]}>
              <Text style={[styles.statusBadgeText, engagementMode.visualsOn && styles.statusBadgeTextActive]}>
                {engagementMode.visualsOn ? 'ON' : 'OFF'}
              </Text>
            </View>
          </View>
          {emulationMode && (
            <Pressable style={styles.toggleButton} onPress={handleToggleVisuals}>
              <Text style={styles.toggleButtonText}>Toggle Visuals (Emulation)</Text>
            </Pressable>
          )}
        </View>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.infoNote}>
            Display specifications will be available when connected to real hardware.
          </Text>
        </View>
